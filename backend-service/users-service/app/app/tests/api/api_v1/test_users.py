...
def test_create_user_existing_username(
    ...
    data = {"email": username, "password": password, "first_name": first_name,
            "last_name": last_name}
    r = client.post(
        f"{settings.API_V1_STR}/users/", headers=superuser_token_headers, json=data,
    )
...
def test_retrieve_users(
    ...
    user_in2 = UserCreate(email=username2, password=password2, first_name=first_name2, last_name=last_name2)
